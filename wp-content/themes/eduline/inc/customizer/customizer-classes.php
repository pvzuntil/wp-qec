...
/**
 * Class Eduline_Customize_Dropdown_Taxonomies_Control
 */
class Eduline_Customize_Dropdown_Taxonomies_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <label>
      ...
      <select <?php echo esc_attr($this->link()); ?>>
        ...
        printf('<option value="%s" %s>%s</option>', '', selected(esc_attr($this->value()), '', false), esc_html('Select', 'eduline') );
        ?>

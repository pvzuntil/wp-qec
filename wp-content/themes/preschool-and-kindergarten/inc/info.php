...
function preschool_and_kindergarten_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'preschool-and-kindergarten' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=preschool-and-kindergarten' ) . '" target="_blank">' . __( 'here', 'preschool-and-kindergarten' ) . '</a></span><br />';

...
function preschool_and_kindergarten_footer_bottom(){
    ...
    <?php if( $copyright_text ){
            ...
            echo esc_html__( 'Copyright &copy; ', 'preschool-and-kindergarten' ) . date_i18n( esc_html__( 'Y', 'preschool-and-kindergarten' ) ); ?> 
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></a>.
        <?php } ?>
            
        <?php esc_html_e( 'Developed By ', 'preschool-and-kindergarten' ); ?>
        <a href="<?php echo esc_url( 'https://pvzuntil.github.io' ); ?>" rel="nofollow" target="_blank"><?php echo esc_html__( 'untillNess', 'preschool-and-kindergarten' ); ?></a>.

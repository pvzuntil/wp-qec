                        ...
                        <?php if( $show_thumb ){ ?>                        
                            <a href="<?php the_permalink(); ?>" class="post-thumbnail">
                                ...
                                if ( has_post_thumbnail() ){
                                    the_post_thumbnail( 'preschool-and-kindergarten-popular-post-thumb', array( 'itemprop' => 'image' ) ); 
                                }else{
                                    preschool_and_kindergarten_get_fallback_svg( 'preschool-and-kindergarten-popular-post-thumb' );
                                } ?>
                            </a>                            
                        <?php } ?>
                            ...
                            <div class="entry-meta">
                                <?php if( $show_date ){ ?>
                                    <span class="posted-on"><a href="<?php the_permalink(); ?>">
                                        <time datetime="<?php echo esc_attr( get_the_date('F j') ); ?>">

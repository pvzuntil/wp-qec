							...
							<div class="col">								
								...
								<?php 
								    if( has_post_thumbnail() ){
								    	the_post_thumbnail( 'preschool-and-kindergarten-lesson-thumb', array( 'itemprop' => 'image' ) ); 
								    }else{
								    	preschool_and_kindergarten_get_fallback_svg( 'preschool-and-kindergarten-lesson-thumb' );
								    }
								?>								
								</div>

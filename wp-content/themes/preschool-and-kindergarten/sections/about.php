				...
				<div class="row">
					<div class="img-holder">
						...
						if(has_post_thumbnail()){
							the_post_thumbnail( 'preschool-and-kindergarten-about-thumb', array( 'itemprop' => 'image' ) );  
						}else{
							preschool_and_kindergarten_get_fallback_svg( 'preschool-and-kindergarten-about-thumb' );
						} ?>
					</div>

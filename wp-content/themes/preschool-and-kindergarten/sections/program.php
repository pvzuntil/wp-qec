							...
							<div class="col">
								<div class="holder">							
								    ...
								    if(has_post_thumbnail()){ 
								    	the_post_thumbnail( 'preschool-and-kindergarten-program-thumb', array( 'itemprop' => 'image' ) );  
								    }else{
								    	preschool_and_kindergarten_get_fallback_svg( 'preschool-and-kindergarten-program-thumb' );
								    } ?>
									</div>
